...
public class BoundedMediaForPoissonInterval extends IntervalCalculator {
    ...
    private void setParameters(long maxTimeToConnect, long minTimeToConnect, long maxTimeToDisconnect, long minTimeToDisconnect) {
        BoundedMediaForPoissonInterval.maxTimeToConnect = maxTimeToConnect;
        BoundedMediaForPoissonInterval.minTimeToConnect = minTimeToConnect;
        BoundedMediaForPoissonInterval.maxTimeToDisconnect = maxTimeToDisconnect;
        BoundedMediaForPoissonInterval.minTimeToDisconnect = minTimeToDisconnect;
