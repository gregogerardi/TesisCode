...
public class Simulation {
    ...
    private static void validateExperiment() {
        ...
        for (TransferInfo tInfo : transfers) {
            ...
            time += (subMessagesCount - 1) * NetworkModel.getModel().getTransmissionTime(SchedulerProxy.PROXY, device, Device.MESSAGES_BUFFER_SIZE);
            ...
            time += (subMessagesCount - 1) * NetworkModel.getModel().getTransmissionTime(device, SchedulerProxy.PROXY, Device.MESSAGES_BUFFER_SIZE);
